...
//create an if else statement if it's 11 or earlier, the console will show "Good Morning!"
//if it's between 12-16, console will show "Good Afternoon!"
//if it's between 17-21, console will show "Good Evening!"
//if it's between 22-24, console will show "Good Night!"
        if (hour <= 11) {
